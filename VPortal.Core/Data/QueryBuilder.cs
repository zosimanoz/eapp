...
namespace VPortal.Core.Data
{
    public abstract class QueryBuilder
    {
        ...
        {
            // Get the type of current generic T
        ...
        /// <summary>
        ///     select single item from where condition passed to parameter
        /// <para>condition is an SQL where clause and/or order by clause ex: "where name='bob'" or "where age>=@Age"</para>
        /// <para>parameter is an anonymous type to pass in named parameter values: new { Age = 15 }</para>
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="condition"></param>
        /// <param name="parameters"></param>
        /// <returns>Returns a single entity by a where condition like where age > 10 from table T</returns>
        ...
        /// <summary>
        /// <para>Inserts a row into the database, using ONLY the properties defined by dynamic object</para>
        /// <para>By default inserts into the table matching the class name</para>
        /// <para>-Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Insert filters out Id column and any columns with the [Key] attribute</para>
        /// <para>Properties marked with attribute [Editable(false)] and complex types are ignored</para>
        /// <para>Supports transaction and command timeout</para>
        /// <para>Should Returns the ID (primary key) of the newly inserted record if it is identity using the defined type, otherwise null</para>
        /// </summary>
        ...
        /// <summary>
        /// Returns ID(primary key) of newly created record
        /// </summary>
        /// <param name="entityToInsert"></param>
        /// <returns>Returns the ID (primary key) of the newly inserted record if it is identity using the int? type, otherwise null</returns>
        ...
        /// <summary>
        /// <para>Updates a record or records in the database with only the properties of dynamic object</para>
        ...
        public QueryRequest Update(object entityToUpdate)
        {
            ...
            // build where condition if not given
        ...
        /// <summary>
        ///     Update a record, but this time condition is given when using update
        ///     So, we need not use reflection to build default where conditions
        /// </summary>
        /// <param name="entityToUpdate"></param>
        /// <param name="condition"></param>
        /// <param name="parameters"></param>
        ...
        /// <returns>Returns the number of records effected</returns>
        public QueryRequest Delete<T>(T entityToDelete)
        {
            ...
            // defualt where conditions are built here
        ...
        /// <summary>
        /// <para>Deletes a record or records in the database that match where condition like "where id > 1"</para>
        /// <para>-By default deletes records in the table matching the class name</para>
        /// <para>Table name can be overridden by adding an attribute on your class [Table("YourTableName")]</para>
        /// <para>Returns the number of records effected</para>
        /// </summary>
        ...
        /// <summary>
        /// Delete a list of entity with ID
        /// We can pass multiple ID's in an array
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="ids"></param>
        /// <returns>Record count for affected entites</returns>
        ...
        // for each item in dynamic object, it appends <something> = <test-something>
        ...
        // build where clause from idProps
